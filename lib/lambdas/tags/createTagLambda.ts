...
export class CreateTagLambda {
    ...
    private createLambda() {
        this.lambda = new NodejsFunction(this.stack, 'CreateTagLambda', {
            entry: (join(__dirname, '..', '..', '..', 'src', 'tags', 'createTag.ts')),
            handler: 'handler',
            functionName: 'CreateTagLambda',
            environment: {
